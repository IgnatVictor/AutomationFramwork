...
public class TestNGReport implements IReporter {
    ...
    GetDateTime time= new GetDateTime();
    private static final Logger LOG = Logger.getLogger(TestNGReport.class);
    ...
    private final String dReportTitle = "TestNG Customized Report";
    private final String dReportFileName = "report.html";
    ...
    protected void writeReportTitle(String title) {
        writer.println("<center><h1>" + title + " - " + time.getDate() + "</h1></center>");
    }
